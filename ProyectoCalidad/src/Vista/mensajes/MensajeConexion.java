 ...
 * Techno Engineers
 * MensajeConexion
 * 17/04/2016 -- Autorizo: Marvin Atzael Hernandez Benitez // Scrum Master
 * Modificaciones: 
 * Sirve para mostrar mensaje de error o conexion exitosa a la base de datos
 * Numero de metodos en el codigo: 0
 * Interfaces: 
 */
package Vista.mensajes;

public class MensajeConexion extends javax.swing.JFrame
{

    /**
     * Creates new form MensajeConexion
     */
    ...
    private void initComponents()
    {
        ...
        jBaceptar.setBackground(new java.awt.Color(0, 204, 0));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(MensajeConexion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new MensajeConexion().setVisible(true);
            }
        });
    }
