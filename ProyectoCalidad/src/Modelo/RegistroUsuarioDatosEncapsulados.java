...
public class RegistroUsuarioDatosEncapsulados {
    ...
    /**
     * @param sNombreUsuario the sNombreUsuario to set
     */
    ...
    /**
     * @param iTipoUsuario the iTipoUsuario to set
     */
    ...
    /**
     * @param sFechaIngreso the sFechaIngreso to set
     */
    ...
    /**
     * @param iExpediente the iExpediente to set
     */
    ...
    /**
     * @param iNumero the iNumero to set
     */
    ...
    /**
     * @param iTelCelular the iTelCelular to set
     */
    ...
    /**
     * @param iTelCasa the iTelCasa to set
     */
    ...
    /**
     * @param iTelOficina the iTelOficina to set
     */
    ...
    /**
     * @param sFechaNacimiento the sFechaNacimiento to set
     */
    ...
    /**
     * @param sLugarNacimiento the sLugarNacimiento to set
     */
    ...
    /**
     * @param sEstadoCivil the sEstadoCivil to set
     */
    ...
    /**
     * @param iPasaporteSN the iPasaporteSN to set
     */
    public void setiPasaporteSN(int iPasaporteSN) {
        this.setiPasaporteSN(iPasaporteSN);
    }

    /**
     * @return the sVigenciaPasaporte
     */
    ...
    /**
     * @param sVigenciaPasaporte the sVigenciaPasaporte to set
     */
    ...
    /**
     * @param iNoCartillaMilitar the iNoCartillaMilitar to set
     */
    ...
    /**
     * @param iEstatura the iEstatura to set
     */
    ...
    /**
     * @param sTalla the sTalla to set
     */
    ...
    /**
     * @param sResponsable the sResponsable to set
     */
    ...
    /**
     * @param sTipoSanguineo the sTipoSanguineo to set
     */
    ...
    /**
     * @param sAlergias the sAlergias to set
     */
    ...
    /**
     * @param sEnfermedades the sEnfermedades to set
     */
    ...
    /**
     * @return the sNombreMedicoCabecera
     */
    ...
    /**
     * @param sNombreMedicoCabecera the sNombreMedicoCabecera to set
     */
    ...
    /**
     * @return the iTelMedicoDeCabecera
     */
    ...
    /**
     * @param iTelMedicoDeCabecera the iTelMedicoDeCabecera to set
     */
    ...
    /**
     * @return the sMedicacionDolorDeCabeza
     */
    ...
    /**
     * @param sMedicacionDolorDeCabeza the sMedicacionDolorDeCabeza to set
     */
    ...
    /**
     * @return the sMedicacionDolorDeEstomago
     */
    ...
    /**
     * @param sMedicacionDolorDeEstomago the sMedicacionDolorDeEstomago to set
     */
    ...
    /**
     * @return the sMedicacionDolorMuscular
     */
    ...
    /**
     * @param sMedicacionDolorMuscular the sMedicacionDolorMuscular to set
     */
    ...
    /**
     * @param sMedicacionGripa the sMedicacionGripa to set
     */
    ...
    /**
     * @param sMedicacionOtro the sMedicacionOtro to set
     */
    ...
    /**
     * @param sFormaDeEnterarse the sFormaDeEnterarse to set
     */
    ...
    /**
     * @param cBaila the cBaila to set
     */
    ...
    /**
     * @param sBaile the sBaile to set
     */
    ...
    /**
     * @param sAnteriorBallet the sAnteriorBallet to set
     */
    ...
    /**
     * @param sTiempoQueBailo the sTiempoQueBailo to set
     */
    ...
    /**
     * @param sHorarioDisponible the sHorarioDisponible to set
     */
    ...
    /**
     * @param sPasaporteSN the sPasaporteSN to set
     */
    ...
    /**
     * @return the sCartillaLiberada
     */
    public String getsCartillaLiberada() {
        return sCartillaLiberada;
    }

    /**
     * @param sCartillaLiberada the sCartillaLiberada to set
     */
    public void setsCartillaLiberada(String sCartillaLiberada) {
        this.sCartillaLiberada = sCartillaLiberada;
    }

    /**
     * @return the iNumeroEmer
     */
    public int getiNumeroEmer() {
        return iNumeroEmer;
    }

    /**
     * @param iNumeroEmer the iNumeroEmer to set
     */
    public void setiNumeroEmer(int iNumeroEmer) {
        this.iNumeroEmer = iNumeroEmer;
    }

    /**
     * @return the sMedicacionDiarrea
     */
    ...
    /**
     * @param sMedicacionDiarrea the sMedicacionDiarrea to set
     */
